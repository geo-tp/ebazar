...
class PurchasedSelectionButton extends Component {
                ...
                <div className="main-selection-button">
                    <div className={this.props.selected == 1 ?
                        ...
                        <button onClick={() => this.handleClick(1)}>
                            A Payer<span className="main-selection-button__paid-number"></span>
                            <p><i className="fa fa-2x fa-euro"/></p>
                        </button>
                    </div>
...
PurchasedSelectionButton.propTypes = {
    handleCatChange: PropTypes.func.isRequired
}

export default PurchasedSelectionButton